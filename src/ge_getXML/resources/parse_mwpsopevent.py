...
parser=argparse.ArgumentParser(description='A parser for the Microsoft Windows Powershell Operational event log XML generated by wevutil command.')
...
for event in root:
  ...
  if eventid=="4104":
    if(ps[2].text):
      ...
      #You will find the PowerShell code on ps[2].text
      print((ps[2].text))
